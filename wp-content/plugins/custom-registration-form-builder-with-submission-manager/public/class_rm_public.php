...
class RM_Public {
    ...
    public function enqueue_scripts() {
        ...
        wp_register_script('rm_front_form_script', RM_BASE_URL."public/js/rm_front_form.js",array($this->plugin_name), $this->version, false);
        ...
        wp_register_script('rm_jquery_validate_add', RM_BASE_URL."public/js/additional-methods.min.js");
         wp_enqueue_script('rm_jquery_consitionalize', RM_BASE_URL."public/js/conditionize.jquery.js");
    }

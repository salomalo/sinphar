    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'HELP_ADD_FIELD_LABEL':
                return __("Label of the field as it appears on forms and inside user accounts. This does not apply to fields without labels such as Divider, Spacing, Heading, Paragraph, Rich Text and Shortcode fields.", 'custom-registration-form-builder-with-submission-manager');

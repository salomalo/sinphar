...
<!-- Joyride Magic begins -->
    <ol id="rm-form-sett-dashboard-joytips" style="display:none">
        ...
        <li data-class="rm-permalink-textbox" data-options="tipAdjustmentY:-20">This is form's unique embed code. As the name suggests, you can use this code to embed the form where WordPress shortcode would not work. Like an external webpage. Otherwise, shortcode is always the best way to display the form.</li>
        ...
        <li data-id="rm-thirdparty-section">This area below contains all the third party services that can be configured to work with this form. As more services become available, they will appear here.</li>
        ...
        <li data-id="rm-sidebar-fields" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30">This shows the number of fields on your form across all pages. For example, a form can have 3 pages with 5 fields on each page. The total field count will be 15.</li>
    ...
    <div class="rm-grid-sidebar-2 difl">
        ...
        <div class="rm-grid-section dbfl">
            ...
            <div class="rm-grid-sidebar-row dbfl">
                ...
                <div class="rm-grid-sidebar-row-value difl"><?php echo count($data->form->form_options->form_pages) ? : 1; ?></div>
            </div>
            <div class="rm-grid-sidebar-row dbfl">
                <div class="rm-grid-sidebar-row-icon difl">
        ...
        <div class="rm-grid-section dbfl">
            ...
            <div class="rm-grid-sidebar-row dbfl">
                <div class="rm-grid-sidebar-row-icon difl">
                    <img src="<?php echo RM_IMG_URL; ?>form-overrides-small.png">
                </div>

    ...
    <div class="rm-create-new-from">
        ...
        <div class="rmrow">
            ...
            <div class="rm-form-name rm-dbfl">
                ...
                <span class="rm-form-step rm-difl">1</span><div class="rm-form-head rm-difl">Name of your form<span class="rm-form-sub-head rm-dbfl">Two forms cannot have same name.</span></div> 

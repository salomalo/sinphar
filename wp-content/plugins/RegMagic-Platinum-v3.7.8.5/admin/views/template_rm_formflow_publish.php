        ...
        <div class="rm-grid-section dbfl rm_publish_section" id="rm_publish_embed">  
            ...
            <div class="rm-directory-container dbfl">          
                <div class="rm-section-embedcode rm-section-shortcode">
                    ...
                    <div class="rm-click-to-copy-button" onclick="rm_copy_content(document.getElementById('rmformembedcode'), this)">Copy</div>
                </div>
            </div>
            ...
            <div class="rm-directory-container dbfl">
                ...
                <div class="rm-publish-directory-col rm-difl">  
                    <div class="rm-section-shortcode"> 
                        ...
                        <div class="rm-click-to-copy-button" onclick="rm_copy_content(document.getElementById('rmformuserdircode'), this)">Copy</div>                        
                    </div>
                    <div class="rm_shortcode_help_text">If you want to display only specific users, you can pass one more parameter to the shortcode - filter the list by time of registration. The longer format is: <div data-publish_code="[RM_Users form_id='%fid%' timerange='year']"><?php echo "[RM_Users form_id='{$form_id_to_publish}'  timerange='year']"; ?></div>Where timerange can be year, month, week or today. Also, you can omit form_id parameter to list all the users registered through all the forms.</div>
                </div>
            </div>
        </div>  

        ...
        <form name="rmc_task_settings_form" id="rmc_task_settings_form" action="" method="post" style="display:none">
            ...
            <div class="rm-task-slide rm-task-slide3">
                ...
                <div class="rmrow">
                    ...
                    <div class="rmnote">
                        <div class="rmprenote"></div>
                        <div class="rmnotecontent">Send email to selected users.</div>
                    </div>
                </div>
                ...
                <div class="childfieldsrow" id="rmc_enable_send_mail_action_ctrl_subpanel">                
                    <div class="rmrow">
                        <div class="rmfield" for="rmc_action_send_mail_sub">
                            <label><sup class="required">*</sup>Subject</label>
                        </div>
                        <div class="rminput">
                        ...
                        <div class="rmnote">
                            <div class="rmprenote"></div>
                            <div class="rmnotecontent">Subject for the message you are sending to the users.</div>
                        </div>
                    </div>

                    <div class="rmrow">
                        <div class="rmfield" for="rmc_action_send_mail_body">
                            <label>Body (HTML and Mail-merge supported)</label>
                        </div>
                        <div class="rminput">
                        ...
                        <div class="rmnote">
                            <div class="rmprenote"></div>
                            <div class="rmnotecontent">Email content</div>
                        </div>
                    </div>
                </div>

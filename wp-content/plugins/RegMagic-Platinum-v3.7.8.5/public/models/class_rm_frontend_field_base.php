...
//    }
    ...
    {
        if($this->field_model->field_options->field_is_unique)
        {  
            $this->pfbc_field->addValidation(new Validation_Unique($this->field_model->field_options->un_err_msg,new RM_Unique_Validator($this->field_model->field_id)));
        }

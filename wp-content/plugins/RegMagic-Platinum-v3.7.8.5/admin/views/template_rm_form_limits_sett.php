...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        ////////////////////////
        $form->addElement(new Element_HTML('</div>'));
       // $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_ENABLE_CAPTCHA'), "enable_captcha", array("yes" => ''),array("id" => "id_rm_enable_captcha_cb", "class" => "id_rm_enable_captcha_cb" ,"value"=>$data->model->form_options->enable_captcha, "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ASPM_ENABLE_CAPTCHA')) ));
        
        //$form->addElement(new Element_Radio("<b>" . RM_UI_Strings::get('LABEL_SUB_LIMIT_ANTISPAM') . ":</b>", "sub_limit_antispam", array('yes'=>RM_UI_Strings::get('LABEL_YES'),'no'=>RM_UI_Strings::get('LABEL_NO'),'default'=>RM_UI_Strings::get('LABEL_DEFAULT')), array("id"=>"id_rm_enable_anti","value" => $data->model->form_options->sub_limit_antispam, "longDesc" => RM_UI_Strings::get('LABEL_SUB_LIMIT_ANTISPAM_HELP'))));

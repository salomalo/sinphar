        ...
        <div class="rm-formcard-tabpanel-container rm-difl"> 
            <div class="rm-formcard-tabpanel" id="rm_fcm_panel_build">
                ...
                <div class="rm-formcard-tab-item">  
                    ...
                    <div class="rm-formcard-tabpanel-info">Build your form just as you would like it to appear to your site visitors. Add and set up custom fields, labels, buttons, form pages, colors, backgrounds and more. 
                    </div>
                </div>
            </div>
            ...
            <div class="rm-formcard-tabpanel" id="rm_fcm_panel_publish">
                 <div class="rm-formcard-tabpanel-wrap rm-dbfl">
                     <div class="rm-formcard-tab-items" >
                         ...
                         <div class="rm-formcard-tabpanel-info">RegistrationMagic offers you multiple ways to publish your forms and associated data. Choose what suits you best.</div>

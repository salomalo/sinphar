...
//PFBC form
        ...
        if(!$ssl_available)
            $form->addElement(new Element_HTML('<div class="rmrow" id="rm_jqntice_row"><div class="rmfield" for="rm_field_value_options_textarea"><label></label></div><div class="rminput" id="rm_jqnotice_text">'.'SSL encryption is not available on server! Can not use Stripe.'.'</div></div>'));

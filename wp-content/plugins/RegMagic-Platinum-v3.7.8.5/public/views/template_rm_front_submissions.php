...
?>
    ...
    <div class="operationsbar">
        ...
        <div class="nav">
                ...
                if ($data->payments)
                {
                    ...
                    ?>
            <div class="rmtabs_head" id="rminbox_tab_head" title="<?php echo RM_UI_Strings::get('LABEL_INBOX'); ?>" data-rmt-tabcontent="#rm_inbox_tab" data-rmtabloctitle="<?php echo RM_UI_Strings::get('LABEL_INBOX'); ?>" data-rminboxunreadcount="<?php echo $data->inbox->total_unread_inbox; ?>">
                ...
                if(isset($data->user,$data->user->ID))
                    echo apply_filters('rm_after_front_tabtitle_listing', '',$data->user->ID);
    ...
    include 'template_rm_front_inbox.php';

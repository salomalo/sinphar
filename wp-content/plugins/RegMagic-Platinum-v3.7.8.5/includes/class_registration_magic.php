...
class Registration_Magic
{
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('wp_ajax_nopriv_rm_login_social_user', 'RM_User_Services', 'social_login_using_email');
        $this->loader->add_action('wp_ajax_nopriv_rm_get_instagram_user', 'RM_User_Services', 'get_instagram_user');
